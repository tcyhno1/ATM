            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form id="form" action="/balance/doSave.do" method="post" class="am-form am-form-horizontal">
                            <div class="am-form-group">
                                <label for="money" class="am-u-sm-3 am-form-label">存款金额</label>
                                <div class="am-u-sm-9">
