            ...
            <div class="tpl-block ">
                ...
                <div class="am-g tpl-amazeui-form">
                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form id="form" action="/balance/doRecharge.do" method="post" class="am-form am-form-horizontal">
                            <div class="am-form-group">
                                <label for="money" class="am-u-sm-3 am-form-label">充值金额</label>
                                <div class="am-u-sm-9">
                                    <%--<input id="token" name="token" type="hidden" value="<%=session.getAttribute("token")%>"><br>--%>
                                    <input id="money" name="money" type="text" placeholder="在此输入金额,真实操作，请试0.01">
                                    <small>请输入整数</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <button type="submit" class="am-btn am-btn-primary" onclick="submit">提交</button>
